...
std::vector<armnn::BackendId> xpudefaultBackends = { "XPU" };

void XpuAdditionToPreCompiledTest()
{
    ...
    IOptimizedNetworkPtr optimizedNet = Optimize(*net, xpudefaultBackends, runtime->GetDeviceSpec());
...
BOOST_AUTO_TEST_SUITE(XPUEndToEnd)

BOOST_AUTO_TEST_CASE(AdditionToPreCompiled)
{
    XpuAdditionToPreCompiledTest();
}
