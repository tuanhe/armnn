...
#include "XpuSubgraphViewOptimizer.hpp"

namespace armnn
{

Graph XpuSubgraphViewOptimizer::CloneGraph(const SubgraphView& originalSubgraph)
{
...
SubgraphView XpuSubgraphViewOptimizer::ReinterpretGraphToSubgraph(Graph& newGraph)
{
...
SubgraphView XpuSubgraphViewOptimizer::OptimizeSubgraph(Graph& graph)
{
